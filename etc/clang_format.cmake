...
if (DEFINED CLANG_FORMAT)
    ...
    file (GLOB_RECURSE ALL_C_FILES ${CMAKE_CURRENT_SOURCE_DIR}/src/*.c)
    file (GLOB_RECURSE ALL_H_FILES ${CMAKE_CURRENT_SOURCE_DIR}/src/*.h)
    add_custom_target (bootstrap-format ${CLANG_FORMAT} -i ${ALL_CC_FILES} ${ALL_HH_FILES} ${ALL_C_FILES} ${ALL_H_FILES} COMMENT "Formatted all source files.")
else (NOT DEFINED CLANG_FORMAT)
    add_custom_target (bootstrap-format echo "Could not find clang-format. Please install and re-run cmake")
