...
(module
  ...
  (import "fixpoint" "attach_tree_ro_table_2" (func $attach_tree_ro_table_2 (type 0)))
  ...
  (table $rw_table_3 (export "rw_table_3") 4 externref)
  ...
  (func $identify_procedure
    (param $procedure externref)
    (result externref)
    (call $attach_tree_ro_table_2 (local.get $procedure))
    (table.set $rw_table_3 (i32.const 0) (table.get $ro_table_2 (i32.const 0)))
    (table.set $rw_table_3 (i32.const 1) (call $create_strict_encode (call $create_identification_thunk (table.get $ro_table_2 (i32.const 1)))))
    (table.set $rw_table_3 (i32.const 2) (call $create_strict_encode (call $create_identification_thunk (table.get $ro_table_2 (i32.const 2)))))
    (table.set $rw_table_3 (i32.const 3) (call $create_strict_encode (call $create_identification_thunk (table.get $ro_table_2 (i32.const 3)))))
    (call $create_tree_rw_table_3 (i32.const 4))
  )

  (func (export "_fixpoint_apply") (param $encode externref) (result externref) (local $i i32) (local $x externref)
    (local $okay externref)
    (local $identifiedp externref)
    ...
    (call $identify_procedure (table.get $ro_table_0 (i32.const 2)))
    (local.set $identifiedp)
    ...
    (loop $ro_table_1_loop
          ...
          (table.set $rw_table_0
            ...
            (call $create_resource_limits
                ...
                (i32.const 1)))
          ;; procedure
          (table.set $rw_table_0 (i32.const 1) (local.get $identifiedp))
          ;; x
